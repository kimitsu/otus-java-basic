...
public class Bowl {
     ...
     * @throws IllegalArgumentException if the food capacity is negative, infinite, or not a number
     */
     ...
     * @throws IllegalArgumentException if the amount of food to add is negative, infinite, or not a number
     */
     ...
     * @throws IllegalArgumentException if the amount of food to take is negative, infinite, or not a number
     */
    public boolean take(double foodToTake) {
        if (foodToTake < 0 ||
